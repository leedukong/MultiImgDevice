...
public class CheckoutManager {
    ...
    public static void cancel(Activity activity){
        String sendData = "";
        sendData = "0420" + fs + "10" + fs + "I" + fs + PreferenceManager.getInt(activity, "prev_nice_checkout_approval_price") + fs + "91" + fs + "0" + fs + "00" + fs + PreferenceManager.getString(activity, "prev_nice_checkout_approval_no") + fs + PreferenceManager.getString(activity, "prev_nice_checkout_approval_date") + fs + "2393300001" + fs + fs + fs + fs + "" + fs + fs + fs + "" + fs + "" + fs + fs + "" + fs + "" + fs + fs + fs + fs + fs + fs + fs + fs + fs + fs;
        send(activity, sendData);
    }
