package com.releasetech.multidevice.DessertSettings;
...
public class DessertSettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dessert_settings);
        ...
        for (int row = 0; row < numRows; row++) {
            for (int col = 0; col < numCols; col++) {
                ...
                try {
                    Product product = DessertDataLoader.loadProductByNumber(dbManager, productNumber);
                    dessertProduct.setText(product.name);
                    int tempCurrentCount = DessertDataLoader.loadCurrentStockById(dbManager, product.id);
                    ...
                    rechargeButton.setOnClickListener(v -> {
                        ...
                        int currentCount = DessertDataLoader.loadCurrentStockById(dbManager, product.id);
